      ...
      <div className="nav-1 mt-8 flex-col">
        <Link to="/">
          ...
          >
            ...
            <span className="px-1 rounded-sm border border-[#252525]" title="ctrl+1 to navigate">1</span>
          </div>
        </Link>
        <Link to="/projects">
          <div
          ...
          >
            ...
            <span className="px-1 rounded-sm border border-[#252525]" title="ctrl+2 to navigate">2</span>
          </div>
        </Link>
        <Link to="/stack">
          <div
          ...
          >
            ...
            <span className="px-1 rounded-sm border border-[#252525]" title="ctrl+3 to navigate">3</span>
          </div>
        </Link>
        <Link to="/services">
          <div
          ...
          >
            ...
            <span className="px-1 rounded-sm border border-[#252525]" title="ctrl+4 to navigate">4</span>
          </div>
        </Link>
        <Link to="/aboutme">
          <div
          ...
          >
            ...
            <span className="px-1 rounded-sm border border-[#252525]" title="ctrl+5 to navigate">5</span>
          </div>
        </Link>
      </div>
      <div className="nav-1 mt-4 flex-col">
        ...
        <Link to="/resources">
          ...
          >
            ...
            <span className="px-1 rounded-sm border border-[#252525]" title="ctrl+6 to navigate">6</span>
          </div>
        </Link>
        <Link to="/blogs">
          <div
          ...
          >
            ...
            <span className="px-1 rounded-sm border border-[#252525]" title="ctrl+7 to navigate">7</span>
          </div>
        </Link>
      </div>
      <div className="nav-1 mt-4 flex-col">
